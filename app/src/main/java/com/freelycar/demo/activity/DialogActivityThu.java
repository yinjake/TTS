...
public class DialogActivityThu extends Activity {
    private static final String TAG = DialogActivityThu.class.getSimpleName();
    private static CountDownTimerSupport mTimer;
    long countDownInterval = 1000L;
    static long millisInFuture = 60000L;
    RxDialogmThu mRxDialogThuLoading;
...
//        initUtils();
    ...
    public void onDestroy() {
       ...
       // MyLogUtils.file(TAG, " onDestroy: " + MyApp.isBackground());
        mRxDialogThuLoading.dismiss();
        mRxDialogThuLoading = null;
        mTimer.stop();
        mTimer = null;
...
//        Looper.loop();
    ...
    private void testDialog() {
        mRxDialogThuLoading = new RxDialogmThu(this);
        mRxDialogThuLoading.show();
    }
