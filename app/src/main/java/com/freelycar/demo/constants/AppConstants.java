...
public interface AppConstants {
    ...
    public static final String RESTART_BROADCAST_ACTION = "com.freelycar.demo.ServiceDieListenerBroadcastReceiver";
    public static final String APPLICATION_BROADCAST_ACTION = "com.freelycar.demo.applicationtest";
    public static final String ACTION_OFFONLINETEST = "com.freelycar.plugin.OFFONLINETEST";
    public static final String ACTION_DIALOGTEST = "com.freelycar.plugin.dialog_test";
