package com.freelycar.demo.rxkit.service
...
import com.freelycar.demo.rxkit.RxLocationTool
...
class RxServiceLocation : Service() {
    ...
    private val mOnLocationChangeListener: RxLocationTool.OnLocationChangeListener = object :
        RxLocationTool.OnLocationChangeListener {
