package com.freelycar.demo.rxkit.crash;
...
import com.freelycar.demo.rxkit.RxAppTool;
import com.freelycar.demo.rxkit.RxDataTool;
import com.freelycar.demo.rxkit.TLog;
import com.freelycar.demo.rxkit.activity.ActivityCrash;
...
public class TCrashTool {
    ...
    private static final String EXTRA_CONFIG = "com.freelycar.demo.rxkit.crash.tcrashtool.EXTRA_CONFIG";
    private static final String EXTRA_STACK_TRACE = "com.freelycar.demo.rxkit.crash.tcrashtool.EXTRA_STACK_TRACE";
    private static final String EXTRA_ACTIVITY_LOG = "com.freelycar.demo.rxkit.crash.tcrashtool.EXTRA_ACTIVITY_LOG";

    //General constants
    private static final String INTENT_ACTION_ERROR_ACTIVITY = "com.freelycar.demo.rxkit.crash.tcrashtool.ERROR";
    private static final String INTENT_ACTION_RESTART_ACTIVITY = "com.freelycar.demo.rxkit.crash.tcrashtool.RESTART";
    private static final String TAM_HANDLER_PACKAGE_NAME = "com.freelycar.demo.rxkit.crash.tcrashtool";
     ...
     * It will first get activities from the AndroidManifest with intent filter <action android:name="com.freelycar.demo.rxkit.crash.tcrashtool.RESTART" />,
    ...
    /**
     * INTERNAL method used to get the first activity with an intent-filter <action android:name="com.freelycar.demo.rxkit.crash.tcrashtool.RESTART" />,
     ...
     * It will first get activities from the AndroidManifest with intent filter <action android:name="com.freelycar.demo.rxkit.crash.tcrashtool.ERROR" />,
    ...
    /**
     * INTERNAL method used to get the first activity with an intent-filter <action android:name="com.freelycar.demo.rxkit.crash.tcrashtool.ERROR" />,
     * If there is no activity with that intent filter, this returns null.
     *
     * @param context A valid context. Must not be null.
     * @return A valid activity class, or null if no suitable one is found
