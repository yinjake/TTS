...
import com.freelycar.demo.rxkit.RxConstTool.BYTE
import com.freelycar.demo.rxkit.RxConstTool.GB
import com.freelycar.demo.rxkit.RxConstTool.KB
import com.freelycar.demo.rxkit.RxConstTool.MB
import com.freelycar.demo.rxkit.RxConstants.SPACE
import java.io.*
    ...
    companion object {
        ...
        fun byte2Size(byteNum: Long, unit: RxConstTool.MemoryUnit?): Double {
            return if (byteNum < 0) {
                ...
                RxConstTool.MemoryUnit.BYTE -> byteNum.toDouble() / BYTE
                RxConstTool.MemoryUnit.KB -> byteNum.toDouble() / KB
                RxConstTool.MemoryUnit.MB -> byteNum.toDouble() / MB
                RxConstTool.MemoryUnit.GB -> byteNum.toDouble() / GB
        ...
        fun size2Byte(size: Long, unit: RxConstTool.MemoryUnit?): Long {
            return if (size < 0) {
                ...
                RxConstTool.MemoryUnit.BYTE -> size * BYTE
                RxConstTool.MemoryUnit.KB -> size * KB
                RxConstTool.MemoryUnit.MB -> size * MB
                RxConstTool.MemoryUnit.GB -> size * GB
                else -> size * BYTE
            }
        }
