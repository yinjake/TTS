package com.freelycar.voice.audiorecorder.asrt.models;
...
public class Wave {
    ...
    public boolean deserialize(byte[] wavBytes) {
        try
        {
            ...
            int waveType = 0; //  (Byte.toUnsignedInt(byte x))
            ...
            {
                Exception e = new Exception("WAVE");
                throw e;
            }
            ...
            System.arraycopy(wavBytes, p, riffSize, 0, 4); // �ļ�ʣ�೤��
            p += 4;
